...
// for development purpose show all variable color
...
"color-green-0": "#b4f1b4",
"color-green-1": "#8ddb8c",
"color-green-2": "#6bc46d",
"color-green-3": "#57ab5a",
"color-green-4": "#46954a",
"color-green-5": "#347d39",
"color-green-6": "#2b6a30",
"color-green-7": "#245829",
"color-green-8": "#1b4721",
"color-green-9": "#113417",
...
"color-orange-0": "#ffddb0",
"color-orange-1": "#ffbc6f",
"color-orange-2": "#f69d50",
"color-orange-3": "#e0823d",
"color-orange-4": "#cc6b2c",
"color-orange-5": "#ae5622",
"color-orange-6": "#94471b",
"color-orange-7": "#7f3913",
"color-orange-8": "#682d0f",
"color-orange-9": "#4d210c",
...
"color-purple-0": "#eedcff",
"color-purple-1": "#dcbdfb",
"color-purple-2": "#dcbdfb",
"color-purple-3": "#b083f0",
"color-purple-4": "#986ee2",
"color-purple-5": "#8256d0",
"color-purple-6": "#6b44bc",
"color-purple-7": "#5936a2",
"color-purple-8": "#472c82",
"color-purple-9": "#352160",
...
for (const name in colorCode ) {
  colors.innerHTML = colors.innerHTML + `
  <div class="item">
    <input disabled class="color_name" value="${name}"  />
    <span class="color_view" style="background: ${colorCode[name]}" ></span>
  </div>
`
}
let openColorPattel = document.querySelector("#open-color-patel")
openColorPattel.addEventListener("click", (e)=>{
  colors.classList.toggle("show")
})
let colorView = document.querySelectorAll(".color_view")
colorView.forEach(view=>{
